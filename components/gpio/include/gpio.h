...
enum gpio_type {
  ...
  #define GPIO_HOST_PINS_GPIO20 GPIO_PINS(20)
  ...
  #define GPIO_HOST_PINS_GPIO24 GPIO_PINS(24)
  ...
  #define GPIO_HOST_PINS_GPIO28 GPIO_PINS(28)
  #define GPIO_HOST_PINS_GPIO29 GPIO_PINS(29)
  #define GPIO_HOST_PINS_GPIO30 GPIO_PINS(30)
  #define GPIO_HOST_PINS_GPIO31 GPIO_PINS(31)
