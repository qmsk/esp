...
struct leds_protocol_type leds_protocol_sk9822 = {
  ...
  .spi_interface_func = LEDS_INTERFACE_SPI_FUNC(spi_mode_32bit, leds_protocol_sk9822_spi_out),
#endif
#if CONFIG_LEDS_I2S_ENABLED
  .i2s_interface_mode = LEDS_INTERFACE_I2S_MODE_32BIT_BCK,
  .i2s_interface_func = LEDS_INTERFACE_I2S_FUNC(i2s_mode_32bit, leds_protocol_sk9822_i2s_out),
#endif
