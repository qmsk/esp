...
# endif
  ...
  { CONFIG_TYPE_BOOL, "sequence_loop",
    .bool_type = { .value = &LEDS_CONFIG.sequence_loop },
  },
  { CONFIG_TYPE_FILE, "sequence_file",
    .file_type = { .value = LEDS_CONFIG.sequence_file, .size = sizeof(LEDS_CONFIG.sequence_file), .paths = leds_sequence_paths },
  },
  { CONFIG_TYPE_ENUM, "sequence_format",
    .description = "LED color format for seqquence channels",
