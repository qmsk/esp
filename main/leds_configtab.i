...
const struct configtab LEDS_CONFIGTAB[] = {
  ...
  { CONFIG_TYPE_UINT16, "artnet_universe_start",
    ...
    .description = "Output from NET DMX universe (0-15) within [artnet] net/subnet.",
    .uint16_type = { .value = &LEDS_CONFIG.artnet_universe_start, .max = ARTNET_UNIVERSE_MAX },
  },
  { CONFIG_TYPE_UINT16, "artnet_universe_count",
    .description = "Output from multiple NET DMX universes, from artnet_universe_start to artnet_universe_step * artnet_universe_count.",
  ...
  { CONFIG_TYPE_UINT16, "artnet_dmx_addr",
    .description = "Start at DMX address within Art-NET DMX universe. The first channel is adress 1",
  ...
  { CONFIG_TYPE_UINT16, "artnet_dmx_leds",
    ...
    .description = "Limit number of LEDs per Art-NET DMX universe.",
