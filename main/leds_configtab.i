...
# endif
  ...
  { CONFIG_TYPE_UINT16, "artnet_dmx_leds",
    ...
    .description = "Limit number of LEDs per Art-Net DMX universe. Default 0 -> as many LEDs as will fit with the given format (e.g. RGB -> 170).",
    .uint16_type = { .value = &LEDS_CONFIG.artnet_dmx_leds },
  ...
  { CONFIG_TYPE_UINT16, "sequence_leds_group",
    .description = "Group multiple consecutive LEDs for common per-format parameters.",
    .uint16_type = { .value = &LEDS_CONFIG.sequence_leds_group },
  },
  { CONFIG_TYPE_UINT16, "sequence_leds_offset",
    .description = "Offset to first LED inside per-format Group data.",
