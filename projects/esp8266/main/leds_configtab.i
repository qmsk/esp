...
const struct configtab LEDS_CONFIGTAB[] = {
  ...
  { CONFIG_TYPE_ENUM, "spi_rate",
    ...
    .enum_type = { .value = &LEDS_CONFIG.spi_clock, .values = leds_rate_enum },
  },
  ...
  { CONFIG_TYPE_ENUM, "artnet_mode",
    ...
    .enum_type = { .value = &LEDS_CONFIG.artnet_mode, .values = leds_artnet_mode_enum },
  },
  ...
  { CONFIG_TYPE_UINT16, "artnet_universe_leds",
    ...
    .uint16_type = { .value = &LEDS_CONFIG.artnet_universe_leds, .max = LEDS_ARTNET_UNIVERSE_LEDS },
  },
  { CONFIG_TYPE_UINT16, "artnet_dmx_addr",
    .description = "Start at DMX address within artnet universe. The first channel is adress 1",
    .uint16_type = { .value = &LEDS_CONFIG.artnet_dmx_addr, .max = 512 },
  },
